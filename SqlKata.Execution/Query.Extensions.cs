...
namespace SqlKata.Execution
{
    public static class QueryExtensions
    {
        ...
        public static T Aggregate<T>(this Query query, string aggregateOperation, string[] columns, IDbTransaction transaction = null, int? timeout = null)
        {
            ...
            return db.ExecuteScalar<T>(query.SelectAggregate(aggregateOperation, columns, AbstractAggregateColumn.AggregateDistinct.aggregateNonDistinct), transaction, timeout);
        }
        ...
        {
            var db = CreateQueryFactory(query);
            return await db.ExecuteScalarAsync<T>(query.SelectAggregate(aggregateOperation, columns, AbstractAggregateColumn.AggregateDistinct.aggregateNonDistinct), transaction, timeout, cancellationToken);
        }
