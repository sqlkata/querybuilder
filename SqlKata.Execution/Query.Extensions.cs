...
namespace SqlKata.Execution
{
    public static class QueryExtensions
    {
        ...
        {
            var db = CreateQueryFactory(query);
            return await db.ExecuteScalarAsync<T>(query.SelectAggregate(aggregateOperation, columns, AbstractAggregateColumn.AggregateDistinct.aggregateNonDistinct), transaction, timeout);
        }
