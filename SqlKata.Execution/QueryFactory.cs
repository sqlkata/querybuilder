...
namespace SqlKata.Execution
{
    public class QueryFactory : IDisposable
    {
        ...
        {
            return this.ExecuteScalar<T>(query.SelectAggregate(aggregateOperation, columns, AbstractAggregateColumn.AggregateDistinct.aggregateNonDistinct), transaction, timeout ?? this.QueryTimeout);
        }
        ...
        )
        {
            return await this.ExecuteScalarAsync<T>(
                query.SelectAggregate(aggregateOperation, columns, AbstractAggregateColumn.AggregateDistinct.aggregateNonDistinct),
                transaction,
                timeout
            );
        }
