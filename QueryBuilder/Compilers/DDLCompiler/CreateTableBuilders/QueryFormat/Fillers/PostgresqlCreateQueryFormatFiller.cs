...
namespace SqlKata.Compilers.DDLCompiler.CreateTableBuilders.QueryFormat.Fillers
{
    internal class PostgresqlCreateQueryFormatFiller : ICreateQueryFormatFiller
    {
        ...
        public PostgresqlCreateQueryFormatFiller(IColumnCompiler columnCompiler, IPrimaryKeyCompiler primaryKeyCompiler, IUniqueConstraintCompiler uniqueConstraintCompiler)
        {
