...
namespace SqlKata
{
    public partial class Query
    {
        ...
        public Query HavingLike(string column, object value, bool caseSensitive = false, char? escapeCharacter = null)
        {
        ...
        public Query HavingEnds(string column, object value, bool caseSensitive = false, char? escapeCharacter = null)
        {
            return AddComponent(new BasicStringCondition
            {
                Engine = EngineScope,
