...
public class OracleDateConditionTests : TestSupport
{
    ...
    public void SimpleWhereDateTest()
    {
        ...
        // Assert:
        Assert.Equal(
            $"SELECT * FROM \"{TableName}\" WHERE TO_CHAR(\"STAMP\", 'YY-MM-DD') = TO_CHAR(TO_DATE(?, 'YY-MM-DD'), 'YY-MM-DD')",
            ctx.RawSql);
    ...
    public void SimpleWhereTimeWithSecondsTest()
    {
        ...
        // Assert:
        Assert.Equal(
            $"SELECT * FROM \"{TableName}\" WHERE TO_CHAR(\"STAMP\", 'HH24:MI:SS') = TO_CHAR(TO_DATE(?, 'HH24:MI:SS'), 'HH24:MI:SS')",
            ctx.RawSql);
    ...
    public void SimpleWhereTimeWithoutSecondsTest()
    {
        ...
        // Assert:
        Assert.Equal(
            $"SELECT * FROM \"{TableName}\" WHERE TO_CHAR(\"STAMP\", 'HH24:MI:SS') = TO_CHAR(TO_DATE(?, 'HH24:MI'), 'HH24:MI:SS')",
            ctx.RawSql);
