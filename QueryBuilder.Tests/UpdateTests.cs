...
public class UpdateTests : TestSupport
{
    ...
    public void UpdateWithEmptyString()
    {
        ...
        Assert.Equal("UPDATE [Books] SET [Author] = 'Author 1', [Description] = '' WHERE [Id] = 1",
            c[EngineCodes.SqlServer]);
    ...
    {
        var book = new Book("SqlKataBook", "Kata", color: "red", price: 100m);
    ...
    public void UpdateFromQueryShouldFail()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => { Compile(query); });
    }
    ...
    private class Book
    {
        ...
        [Column("Author")] public string BookAuthor { get; set; }
    ...
    private class OrderProductComposite
    {
        ...
        [Column("Faa")] public string Foo { get; set; }
    }
}
